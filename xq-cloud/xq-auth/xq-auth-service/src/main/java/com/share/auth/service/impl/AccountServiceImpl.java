...
import com.share.auth.service.IAccountService;
import com.share.auth.service.ILoginRecordService;
import com.share.auth.util.JwtTool;
 ...
 * @author xq-cloud
 * @version 1.0
 * @description: 账号表，平台内所有用户的账号、密码信息 服务实现类
 * @date 2026/3/7 17:03
 */
@Slf4j
@Service
