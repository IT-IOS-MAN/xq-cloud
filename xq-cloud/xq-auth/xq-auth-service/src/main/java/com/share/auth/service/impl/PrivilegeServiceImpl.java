...
import com.share.auth.mapper.PrivilegeMapper;
import com.share.auth.service.IPrivilegeService;
import com.share.auth.service.IRolePrivilegeService;
import com.share.auth.service.IRoleService;
import com.share.auth.util.PrivilegeCache;
...
import static com.share.auth.constants.AuthConstants.ADMIN_ROLE_ID;

/**
 * @author xq-cloud
 * @version 1.0
 * @description: 权限表，包括菜单权限和访问路径权限 服务实现类
 * @date 2026/3/7 19:11
 */
@Service
...
public class PrivilegeServiceImpl extends ServiceImpl<PrivilegeMapper, Privilege> implements IPrivilegeService {
    ...
    @Override
    public Page<Privilege> listPrivilegesByPage(PageSO pageQuery) {
        // 1.分页查询
        return query()
